...
export function registerInspectLayout(server: McpServer): void {
  server.tool(
    "inspect_layout",
    "Capture the full page layout tree with computed styles, box models, and element relationships. Returns a structured tree overview optimized for LLM reasoning.",
    {
    ...
    async (params) => {
      ...
      try {
        ...
        const text = formatLayoutOverview(tree);
